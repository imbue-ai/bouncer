...
class ShieldConfigurationExtension: ShieldConfigurationDataSource {
    ...
    /// answer with — X, LinkedIn, Instagram — and a shield over anything else
    /// is a door with one way through rather than a door that lies.
