...
class ShieldActionExtension: ShieldActionDelegate {
    ...
    private func respond(to action: ShieldAction,
        ...
        // iOS 26.4's submenu cases land here too — from a submenu this shield
        // does not configure (the fork is two buttons and nothing else,
        // deliberately; see the note in ShieldConfigurationExtension about
        // "just this once"), so declining them is right. They are not named
        // because this SDK (26.2) does not know them yet; name them once the
