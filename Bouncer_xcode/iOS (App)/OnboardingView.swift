...
// MARK: - Intentional Scroll Page (Screen Time + notifications + the shield)
//
...
// controls live in Settings under Intentional Scroll for anyone who arrives at
// the question later.
...
private struct GateSetupPage: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            // nothing but a trip to Intentional Scroll. See GateSetupSections.
            List {
