...
public enum Gate {
    ...
    /// The feature's user-facing name — one spelling, everywhere it appears.
    public static let featureName = "Intentional Scroll"

    /// The shield's second button. Rendered by the shield extension and mocked
    /// by the in-app preview — one definition so the preview can't drift.
    public static let viewInBouncerLabel = "View in Bouncer"
